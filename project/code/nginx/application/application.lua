ngx.say(ngx.shared.redis_cluster_addr:get('redis-addr'))
--分隔函数
...
local config = {
    ...
    --[[serv_list = {                           --redis cluster node list(host and port),
            { ip = "140.143.16.122", port = 6391 },
            { ip = "140.143.16.122", port = 6392 },
            { ip = "140.143.16.122", port = 6393 },
            { ip = "140.143.16.122", port = 6394 },
            { ip = "140.143.16.122", port = 6395 },
